...
import { AmHere, restaurantslist } from '../lip/ApiUrl'

const IamHere = ({ navigation, onPress }) => {
  ...
  const IAmHereApi=()=>{
    ...
    Helper.makeRequest({url:AmHere,method:"GET"}).then((response)=>{
console.log("======>>>>>IAmHereApiIAmHereApiIAmHereApiIAmHereApiIAmHereApi--------: ", response.data)
